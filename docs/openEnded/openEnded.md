...
在好大夫工作期间，主要是负责公司重点、难点、战略型项目的开发和管理、包括好大夫的 VIP 项目、好大夫全家宝、预问诊流程、HIS 系统等项目。
...
- 这个项目的难点主要有这些：
	...
	- 3、项目对性能要求较高，因为涉及到了所有的主要业务，所以对性能要求很高。我在团队中使用了 lighthouse、webpagetest 对主要页面的性能进行优化。
